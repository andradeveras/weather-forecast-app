...
class DailyForecastTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier reuseIdentfier: String?) {
        super.init(style: style, reuseIdentifier: reuseIdentfier)
        setupView()
    }
